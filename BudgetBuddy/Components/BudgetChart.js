...
const BudgetChart = ({navigation}) => {
  // Navigate to the Edit Expenses screen
  const movetoEdit = () => navigation.navigate('EditEx')
  return ( 
    <ScrollView 
    ...
    >
      <View style={styles.centeredContent}>
        ...
        <TouchableOpacity style={styles.updateButton} onPress={movetoEdit}>
...
const styles = StyleSheet.create({
  scrollView: { //Fixes Scrolling Problem
    flex: 1,
    width: '100%',
  },
  scrollContent: {
